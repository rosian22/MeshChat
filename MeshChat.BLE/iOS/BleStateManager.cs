...
/// <summary>
/// Orchestrates iOS BLE peripheral and central services with keep-alive support.
...
public class BleStateManager : IBleService
{
    ...
    public BleStateManager(MeshRouter meshRouter)
    {
        _meshRouter = meshRouter ?? throw new ArgumentNullException(nameof(meshRouter));
        _peripheralService = new BlePeripheralService();
        _centralService = new BleCentralService();
